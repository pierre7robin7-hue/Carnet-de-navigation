...
function MapPage({ outings }) {
  ...
  React.useEffect(() => {
    ...
    const map = L.map(ref.current, { scrollWheelZoom: true, zoomControl: false, attributionControl: false });
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 space-y-4">
      ...
      {outings.length === 0 ? (
        ...
        <div className="bg-white rounded-2xl shadow-soft overflow-hidden">
          ...
          <div className="flex flex-wrap items-center gap-4 px-5 py-3.5 border-t border-navy-50 text-xs text-navy-400">
          ...
          {unresolved.length > 0 && (
            <div className="px-5 py-4 border-t border-navy-50">
              <p className="text-xs font-semibold text-navy-500 mb-1 flex items-center gap-1.5">
